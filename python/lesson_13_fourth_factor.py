...
result = minimize(get_sharpe, initial_weights,
                  args=(r1, r2, r3, r4, returns, None, None),
                  method='SLSQP',
                  bounds=bounds,
                  constraints=constraints)

optimal_w1, optimal_w2, optimal_w3, optimal_w4 = result.x
print(f"Optimal weights — Momentum: {optimal_w1:.2f}, Reversal: {optimal_w2:.2f}, Low Vol: {optimal_w3:.2f}, 52 Week High: {optimal_w4:.2f}")

# Use optimal weights
composite = (optimal_w1*r1 + optimal_w2*r2 + optimal_w3*r3 + optimal_w4*r4)
